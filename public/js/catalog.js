...
export const JUEGOS = [
  ...
  {
    id: "memory-ingles",
    titulo: "Memory in English",
    descripcion: "Memoria con dibujos y palabras en inglés: animals, colors, fruits, clothes, body y school. ¡Con voz!",
    emoji: "🧠",
    materia: "ingles",
    grados: [1, 2, 3, 4],
    url: "juegos/memory-ingles.html",
  },
  {
    id: "efemerides",
    titulo: "Efemérides",
    descripcion: "15 de setiembre, 25 de julio, 11 de abril… ¿qué celebramos cada día y por qué?",
    emoji: "📅",
    materia: "sociales",
    grados: [2, 3, 4, 5, 6],
    url: "juegos/efemerides.html",
  },
  {
    id: "ortografia",
    titulo: "Ortografía",
    descripcion: "¿Vaca con b o con v? ¿Lápiz con s o con z? ¿Huevo lleva h? Completá las palabras y aprendé las reglas.",
    emoji: "🐝",
    materia: "espanol",
    grados: [3, 4, 5, 6],
    url: "juegos/ortografia.html",
  },
  {
    id: "ecosistemas",
    titulo: "Ecosistemas de Costa Rica",
    descripcion: "Bosque nuboso, bosque seco, manglar, arrecife, páramo… ¿quién vive en cada uno y cómo son?",
    emoji: "🌳",
    materia: "ciencias",
    grados: [3, 4, 5, 6],
    url: "juegos/ecosistemas.html",
  },
  {
    id: "estados",
    titulo: "Sólido, líquido o gaseoso",
    descripcion: "¿El hielo es sólido? ¿Y el vapor? Descubrí los estados del agua y qué pasa con el calor y el frío.",
    emoji: "🧊",
    materia: "ciencias",
    grados: [1, 2, 3, 4],
